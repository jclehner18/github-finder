  ...
  return (
    <>
        <div className="w-full mx-auto lg:w-10/12">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gp-8">
            ...
            <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <FaUsers className='text-3xl md:text-5xl' color='#89CFF0' />
                    </div>
                ...
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <FaUserFriends className='text-3xl md:text-5xl' color='#89CFF0' />
                    </div>
                    <div className="stat-title pr-5">
                        Following
                    </div>
                ...
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <FaCodepen className='text-3xl md:text-5xl' color='#89CFF0' />
                    </div>
                    <div className="stat-title pr-5">
                        Public Repos
                    </div>
                ...
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <FaStore className='text-3xl md:text-5xl' color='#89CFF0' />
                    </div>
                    <div className="stat-title pr-5">
                        Public Gists
                    </div>
